...
from abc import ABC, abstractmethod # Импортируем библиотеки необходимые для создания игры
class Weapon(ABC):
    @abstractmethod
    def attack(self):
        pass

class Sword(Weapon): # Создаём класс Sword, представляющий оружие
    def attack(self):
        print("Боец наносит удар мечом.")

class Bow(Weapon): # Создаём класс Bow, представляющий оружие
    def attack(self):
        print("Боец стреляет в монстра стрелой из лука.")
